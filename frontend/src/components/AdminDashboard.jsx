...
export default function AdminDashboard() {
  ...
  return (
    <div>
      ...
      <div className="cards">
        <div className="card">
          <div className="card__icon card__icon--total">📦</div>
        ...
        <div className="card">
          <div className="card__icon card__icon--warning">⚠️</div>
          <div className="card__body">
        ...
        <div className="card">
          <div className="card__icon card__icon--danger">🚫</div>
          <div className="card__body">
      ...
      <div className="cards" style={{ marginTop: '1rem' }}>
        ...
        <div className="card">
          <div className="card__icon card__icon--total">🏷️</div>
          <div className="card__body">
